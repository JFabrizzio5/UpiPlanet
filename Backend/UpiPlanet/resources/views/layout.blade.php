        ...
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
            ...
            <div class="flex items-center space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
                <button type="button"
                    ...
                    <img class="w-8 h-8 rounded-full" src="https://avatars.githubusercontent.com/u/115313375?v=4"
                        alt="user photo">
                </button>
                <!-- Dropdown menu -->
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <div class="px-4 py-3">
                        ...
                        <span
                            class="block text-sm text-gray-500 truncate dark:text-gray-400">Josephfabrizziocorreo@gmail.com</span>
                    </div>
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        ...
                        <li>
                            <a href="#"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Registrarse
                                (Proximamente)</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                <ul
                    ...
                    <li>
                        <a href="/"
                            class="block px-3 py-2 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
...
<footer class="m-4 bg-white rounded-lg shadow-sm dark:bg-gray-900">
    <div class="w-full max-w-screen-xl p-4 mx-auto md:py-8">
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
            © 2025 <a href="https://flowbite.com/" class="hover:underline">UpiPlanet™</a>. JFabrizzio5.
        </span>
    </div>
</footer>
