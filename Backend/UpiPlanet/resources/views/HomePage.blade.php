            ...
            <section class="transparent-section">
                <div class="max-w-screen-xl px-2 py-4 mx-auto sm:py-4 lg:px-6">
                    <div class="grid h-full grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-5">
                        ...
                        <!-- Primer div de abajo  -->
                        <!--      <div
                                                    class="flex flex-col h-auto col-span-2 sm:col-span-3 md:col-span-3 md:grid-cols-5 min-h-[150px] sm:min-h-[300px] max-h-[300px] sm:max-h-[150px]">
                                                    <a href=""
                                                        class="relative flex flex-col flex-grow px-5 pt-40 pb-4 overflow-hidden rounded-lg group">
                                                        <img src="{{ asset('img/Notas.webp') }}" alt=""
                                                            class="absolute inset-0 object-cover w-full h-full transition-transform duration-500 ease-in-out group-hover:scale-105">
                                                        <div class="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                                                        <h3
                                                            class="absolute top-0 left-0 z-10 p-4 text-2xl font-medium text-white xs:text-xl md:text-3xl">
                                                            Resumene tus notas IA</h3>
                                                    </a>
                                                </div> -->


                        <!-- Segundo div de abajo (más alto) -->
                        <div
                            class="flex flex-col h-auto col-span-5 sm:col-span-5 md:col-span-5 md:h-full min-h-[150px] sm:min-h-[300px] max-h-[300px] sm:max-h-[150px]">
                            <a href=""
                                class="relative flex flex-col flex-grow px-4 pt-40 pb-4 overflow-hidden rounded-lg group">
                                ...
                                <h3
                                    class="absolute top-0 left-0 z-10 p-4 text-2xl font-medium text-white xs:text-xl md:text-3xl">
                                    Cuaderno y Tareas automaticas IA</h3>
                            </a>
                        </div>
